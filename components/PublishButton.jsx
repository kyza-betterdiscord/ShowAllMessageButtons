const { React, findModule, findModuleByProps, findModuleByDisplayName } = BdApi;
...
const { confirmPublish } = findModuleByProps("confirmPublish");

const iconClasses = findModuleByProps("icon", "isHeader");

export default React.memo(function PublishButton(props) {
	return (
		<Tooltip color="black" postion="top" text="Publish">
